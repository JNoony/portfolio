...
// mobile gnb = dropdown
wid < 559 ? head.classList.add('head-dropdown') & mGnb.classList.add('dropdown-content') 
          : head.classList.remove('head-dropdown') & mGnb.classList.remove('dropdown-content');
